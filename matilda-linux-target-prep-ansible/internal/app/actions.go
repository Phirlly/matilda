...
func WorkflowActions() []ActionSpec {
	return []ActionSpec{
		...
		{ID: "generate-windows", Key: "5", Label: "Windows handoff", Description: "local package only", Group: "Handoff"},
		{ID: "generate-unix", Key: "6", Label: "UNIX handoff", Description: "local instructions only", Group: "Handoff"},
