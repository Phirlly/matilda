...
Start with the root [README](../README.md) or [Quickstart](user/quickstart.md).

## User Docs

These are the docs operators need to run the toolkit:

- [Quickstart](user/quickstart.md)
- [Operator smoke test](user/operator-smoke-test.md)
- [Linux workflow](user/linux.md)
- [Inventory](user/inventory.md)
- [Reports](user/reports.md)
- [Browser UI](user/browser-ui.md)
- [Troubleshooting](user/troubleshooting.md)

## Operator Reference

These explain support boundaries and launch handoff details:

- [Supported platforms](reference/supported-platforms.md)
- [Discovery access model](reference/discovery-access-model.md)
